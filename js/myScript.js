...
const SIZES = [
  ...
  const key_click = new Audio("sounds/click.mp3");

write_letter = function(num, txt) {
  ...
  const sound = new Audio("sounds/startup.mp3");
    ...
    render() {
      ...
      <div class="screen">
        ...
        <p class="last off">
          ...
          ${date()}-i440LX-<strong>UNIWERSYTET ŁÓDZKI</strong>-00
        </p>
      </div>`;
    }
  }
    ...
    setTimeout(() => {
      screen.innerHTML = `
        <p>
          ...
          Start booting <strong>UNIWERSYTET ŁÓDZKI</strong>...<span class="cursor"></span>
        </p>
      `;
    }, 3000);
