...
export class RunningRight extends State {
  ...
  handleInput(input) {
    ...
    else if (input.w.pressed && this.player.vy === 0) this.player.setState(states.JUMPING_RIGHT);
  }
}
...
export class JumpingRight extends State {
  ...
  handleInput(input) {
    ...
    else if (!input.w.pressed && this.player.vy === 0) this.player.setState(states.STANDING_RIGHT);
  }
}
